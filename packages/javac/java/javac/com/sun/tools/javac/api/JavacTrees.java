...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
            ...
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (javac.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
     ...
     */
    public TypeMirror getOriginalType(javac.javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof javac.com.sun.tools.javac.code.Type.ErrorType) {
            return ((javac.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return javac.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            javac.com.sun.source.tree.Tree t,
            javac.com.sun.source.tree.CompilationUnitTree root) {
