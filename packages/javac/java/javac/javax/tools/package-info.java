 ...
 * ({@linkplain javac.javax.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@linkplain
 * javac.javax.tools.JavaFileManager} and {@linkplain
 * javac.javax.tools.JavaFileObject}).  See {@linkplain
 * javac.javax.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@linkplain javac.javax.tools.ToolProvider}, for example:
 *
 ...
 * META-INF/services/javac.javax.tools.JavaCompiler}.  This file would
