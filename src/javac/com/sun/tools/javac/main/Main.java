...
public class Main {
    ...
    public List<File> processArgs(String[] flags) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "javac.com.sun.tools.javac.Main";
            showClass(showClass);
        }
                       ...
                       Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            // as specified by javac.javax.tools.JavaCompiler#getTask
            // and javac.javax.tools.JavaCompiler.CompilationTask#call
            throw new RuntimeException(ex.getCause());
...
//      System.out.println("(name buffer len = " + Name.names.length + " " + Name.nc);//DEBUG
    ...
    private static final String javacBundleName =
        "javac.com.sun.tools.javac.resources.javac";
