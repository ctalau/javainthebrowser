...
import javac.javax.lang.model.type.ErrorType;
import javac.javax.lang.model.type.TypeMirror;
import javac.javax.tools.Diagnostic;
import javac.javax.tools.JavaCompiler.CompilationTask;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        if (!task.getClass().getName().equals("javac.com.sun.tools.javac.api.JavacTaskImpl"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("javac.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    /**
      ...
      * @return javac.javax.lang.model.type.TypeMirror corresponding to the original type, replaced by the ErrorType.
      */
