 ...
 * javac.javax.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link javac.javax.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain javac.javax.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * javac.javax.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * javac.javax.lang.model.SourceVersion#isIdentifier identifiers}:
     *
     * <blockquote>
     * <dl>
     ...
     * @see javac.javax.annotation.processing.SupportedOptions
     */
     ...
     * @see javac.javax.annotation.processing.SupportedAnnotationTypes
     * @jls 3.8 Identifiers
     ...
     * processor.
     * @see javac.javax.annotation.processing.SupportedSourceVersion
    ...
    * <blockquote>
    * <pre>
    * import static javac.javax.annotation.processing.Completions.*;
    * ...
