...
package javac.javax.lang.model.element;
 ...
 * javac.javax.annotation.processing.ProcessingEnvironment annotation
 * processing}, the guarantees for "the same" implementation must
 * include contexts where the {@linkplain javac.javax.annotation.processing
 * API mediated} side effects of {@linkplain
 * javac.javax.annotation.processing.Processor processors} could be visible
 * to each other, including successive annotation processing
 * {@linkplain javac.javax.annotation.processing.RoundEnvironment rounds}.
 *
 * @author Joseph D. Darcy
 * @author Scott Seligman
 * @author Peter von der Ah&eacute;
 * @see javac.javax.lang.model.util.Elements#getName
 * @since 1.6
 */
