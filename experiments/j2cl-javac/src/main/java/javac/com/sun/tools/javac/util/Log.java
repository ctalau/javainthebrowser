...
import static javac.com.sun.tools.javac.main.OptionName.DOE;
import static javac.com.sun.tools.javac.main.OptionName.PROMPT;
...
public class Log extends AbstractLog {
    ...
    public void reportDeferredDiagnostics() {
        reportDeferredDiagnostics(new HashSet<>(Arrays.asList(JCDiagnostic.Kind.values())));
    }
