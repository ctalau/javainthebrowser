...
public class ZipFileIndex {
    ...
    // finalize() removed: not available in J2CL's Object emulation
     ...
     */
    public synchronized javac.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            javac.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return javac.com.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            javac.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private javac.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = javac.com.sun.tools.javac.util.List.<String>nil();
        private javac.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = javac.com.sun.tools.javac.util.List.<String>nil();
        ...
        private javac.com.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private javac.com.sun.tools.javac.util.List<String> getDirectories() {
