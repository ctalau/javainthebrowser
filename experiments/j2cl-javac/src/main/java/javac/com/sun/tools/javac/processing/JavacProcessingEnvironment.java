...
import static javac.com.sun.tools.javac.main.OptionName.XPRINTPROCESSORINFO;
import static javac.com.sun.tools.javac.main.OptionName.XPRINTROUNDS;
...
import javac.javax.lang.model.util.ElementScanner7;
...
import javac.com.sun.tools.javac.api.JavacTaskImpl;
import javac.com.sun.tools.javac.api.JavacTrees;
...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
    ...
    class Round {
        ...
        void showDiagnostics(boolean showAll) {
            Set<JCDiagnostic.Kind> kinds = new HashSet<>(Arrays.asList(JCDiagnostic.Kind.values()));
            if (!showAll) {
