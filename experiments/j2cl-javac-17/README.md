...
- Added another shim refinement wave (including additional `Path`/`URI`/`System`/`VM`/`String` compatibility signatures and module patching split between `java.base` + `java.compiler`), reducing transpile failures from 96 to 81.
